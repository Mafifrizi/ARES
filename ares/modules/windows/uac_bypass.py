...
from ares.modules.params import UACBypassParams
...
class UACBypassModule(BaseModule):
    ...
    async def execute(self, ctx: "Any") -> "ModuleResult":
        ...
        if isinstance(params, UACBypassParams):
        ...
        for finding in findings:
            ev = EvidenceRecord(
                artifact_id=f"windows-uac-{target.replace('.', '-')}",
