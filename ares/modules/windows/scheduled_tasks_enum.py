...
from ares.modules.params import ScheduledTasksEnumParams
...
@module_contract(
    ...
    params_model=ScheduledTasksEnumParams,
)
class ScheduledTasksEnumModule(BaseModule):
    ...
    async def execute(self, ctx: "Any") -> "ModuleResult":
        ...
        if isinstance(params, ScheduledTasksEnumParams):
        ...
        for finding in findings:
            ev = EvidenceRecord(
                artifact_id=f"windows-tasks-{target.replace('.', '-')}",
                ...
                tags=["windows", "scheduled_tasks_enum"],
            )
